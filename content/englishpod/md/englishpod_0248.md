...
- **to set the table** *P* — prepare the table so as to sit down and eat
- **anything in particular** *P* — anything specific
- **silverware** *N* — eating utensils: fork, spoon, knife
- **to roast** *V* — to bake uncovered, esp. in an oven
- **serving dish** *N* — a dish used for serving food

## Supplementary Vocabulary

- **fork** *N* — a fork used specifically for eating salads
- **fine china** *N* — a term used for expen- sive dinnerware
- **spoon** *N* — spoon used specifically for eating soup
- **dinner party** *N* — inviting friends over for dinner
- **tea kettle** *N* — a pot used for boiling the water for tea
