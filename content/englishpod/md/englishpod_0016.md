...
- **uturn** *Phrase* — a 180 degree turn in the car
- **to back up** *Verb, finitive* — In- to move backwards, the opposite of go forwards
- **to pass** *Verb, finitive* — In- to drive past another car on the road to pass a car on the road
- **to park** *Verb, finitive* — In- to stop the car and turn off the engine
