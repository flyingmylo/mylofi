...
- **trendy** *A* — following the latest trends
- **on top of all that** *P* — besides that
- **reconsider** *V* — to think carefully about something again
- **hygienic** *A* — clean and unlikely to cause illness
- **sterilized** *A* — completely clean and free from germs

## Supplementary Vocabulary

- **rebellious** *A* — defying authority, going against the mainstream
- **body art** *N* — used to describe tat- toos, but also other, more temporary forms of decorating the body
- **temporary** *A* — existing for only a short period of time
- **permanent** *A* — something that exists for a long time; does not leave
