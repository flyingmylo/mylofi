...
- **take someone to jail** *phrase* — take someone who is ar- rested to a place where other criminals are kept
- **book** *verb* — arrest (informal)
- **claim** *verb* — say something is true when some people say it may not be true
- **stocking** *common noun, singular* — large sock; tradition- ally, Christmas gifts are put inside on the Christmas Eve
- **speed** *verb* — drive faster than legal speed limit
- **impound** *verb* — held by the police
- **ruined** *Adjective* — damaged or destroyed
- **reindeer** *common noun, nonvariable* — large deer that lives in the north part of the globe
- **elf** *common noun, singular* — small creature (in sto- ries) that have pointed ears and magic powers
...
- **backup** *common noun, nonvariable* — help

## Supplementary Vocabulary

- **charge** *verb* — formally accuse some- one of a crime
- **pull someone over** *phrase* — make a moving car move to the side of the road
- **ambush** *common noun, singular* — a sudden attack
- **stocking** *common* — small gifts that are put
- **stuffer** *noun, singular* — in the Christmas stock- ing
- **Christmas or** *common* — decoration that is used
- **nament** *noun, singular* — to make the Christmas tree beautiful
