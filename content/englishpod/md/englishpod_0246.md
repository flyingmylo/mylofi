# Daily Life - At The Train Station
...
- **one way ticket** *N* — a ticket that allows you only to go to a certain destination
- **depart** *V* — to leave, start a voyage
- **platform** *N* — A flat elevated portion of ground
- **on the dot** *P* — on time, precisely at a certain time
- **scheduled departure time** *P* — planned at a specific time to leave

## Supplementary Vocabulary

- **roundtrip ticket** *N* — a ticket to travel to and from your destination
- **coach** *N* — a less expensive travel seating option
- **hardsleeper** *N* — a sleeping train car with less padding
- **softsleeper** *N* — a sleeping train car with more padding
- **train conductor** *N* — the person in charge of operating the train
