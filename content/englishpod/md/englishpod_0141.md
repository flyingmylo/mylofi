...
- **now that I think of it** *phrase* — used to express a real- ization
...
- **architecture** *common noun, nonvariable* — the art and science of designing buildings
...
- **wreck** *verb* — to ruin or destroy some- thing (like a car)
- **remorse** *common noun, nonvariable* — a feeling of guilt
